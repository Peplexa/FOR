...
def process_and_save_dataset(root_dir):
    ...
    save_dataset(features_train, labels_train, './npy/training_features.npy', './npy/training_labels.npy')
    save_dataset(features_val, labels_val, './npy/validation_features.npy', './npy/validation_labels.npy')
    save_dataset(features_test, labels_test, './npy/testing_features.npy', './npy/testing_labels.npy')
