...
def extract_features(audio_path, n_fft=1024):
    ...
    try:
        ...
        agg_features = np.hstack((
            ...
            silence_ratio,
            jitter, shimmer  # Include Jitter and Shimmer
        ))
...
def process_and_save_dataset(root_dir):
    ...
    save_dataset(features_train, labels_train, './npy2/training_features.npy', './npy2/training_labels.npy')
    save_dataset(features_val, labels_val, './npy2/validation_features.npy', './npy2/validation_labels.npy')
    save_dataset(features_test, labels_test, './npy2/testing_features.npy', './npy2/testing_labels.npy')
